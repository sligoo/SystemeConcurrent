package linda.centralized_applications.philosophes;// Time-stamp: <10 jui 2013 16:51 queinnec@enseeiht.fr>
...
public class IHMPhilo {
    ...
    public IHMPhilo (String nomstrategie, int _nbPhilosophes, Simulateur _simu)
    {
        ...
        // Fenetre
        final JFrame fenetre = new JFrame("Main");
