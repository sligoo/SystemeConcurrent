package linda.centralized_applications.philosophes;// Time-stamp: <02 mai 2013 10:25 queinnec@enseeiht.fr>

import linda.centralized_applications.philosophes.Synchro.Simulateur;
...
public class Main {
    ...
    static public void initialiser (String nomImplantation, int nbPhilo) {
        ...
        strategie = charger_implantation("linda.centralized_applications.philosophes.StrategiePhilo", nomImplantation, nbPhilosophes);
