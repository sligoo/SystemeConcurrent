package linda.centralized_applications.philosophes;// Time-stamp: <03 mai 2013 11:13 queinnec@enseeiht.fr>
...
public class IHMArgs extends JDialog {
    ...
    public IHMArgs (Frame frame)
    {
        ...
        final String[] choix = trouver_implantations("linda.centralized_applications.philosophes.StrategiePhilo");
        ...
        contentPane.add(new JLabel(" Main : "));
    ...
    private String[] trouver_implantations (String interfaceName)
    {
        ...
        String dir = Main.class.getResource("StrategiePhilo.class").getPath();
        dir = dir.substring(0, dir.length() - 21);
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            if (files[i].endsWith (".class")) {
                String classname = "linda.centralized_applications.philosophes." + files[i].substring (0, files[i].length()-6);
                try {
